namespace devdeer.CoffeeCupApiAccess.Logic.Models.JsonConverters
{
    ...
    {
        public override ExpenseCategoryType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, ExpenseCategoryType value, JsonSerializerOptions options)
        {
            var stringValue = value switch
            {
                ...
                _ => throw new InvalidOperationException($"Unexpected value when converting ExpenseCategoryType: {value}")
            };
